            ...
            <div class="w-full max-w-full sm:ml-64 lg:max-w-3xl lg:mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-xl p-3 sm:p-4 mb-4 sm:mb-6">
                    <form action="{{ route('admin.storestaff') }}" method="POST"
                        ...
                        <!-- Specialist -->
                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1">Joinning Date</label>
                            <input type="date" name="joining_date" value="{{ old('date') }}"
                                class="w-full px-1 py-1 sm:px-2 sm:py-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 bg-gray-50 text-gray-700 text-xs transition duration-200">
                            @error('joining_date')
                                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                            @enderror
                                ...
                                @foreach ($staffs as $index => $staff)
                                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <div x-data="{ open: false }">
                                            <!-- Overlay -->
                                            <div x-show="open" class="fixed inset-0 bg-black bg-opacity-40 z-40"
                                                @click="open = false">
                                            </div>

                                            <!-- Modal Box -->
                                            <div x-show="open"
                                                class="fixed inset-0 flex items-center justify-center z-50 overflow-auto p-4">
                                                <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">

                                                    <!-- Close Button -->
                                                    <button @click="open = false"
                                                        class="absolute top-2 right-3 text-gray-600 hover:text-red-500">
                                                        ✖
                                                    </button>

                                                    <!-- Modal Form -->
                                                    <h2 class="text-lg font-semibold mb-4">Edit Staff</h2>
                                                    <form action="" method="POST" class="space-y-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="name" value="{{ $staff->name }}"
                                                                class="w-full mt-1 px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring focus:ring-blue-300">
                                                        </div>
                                                        ...
                                                        <div>
                                                            <label class="text-sm font-medium text-gray-700">Joining
                                                                Date</label>
