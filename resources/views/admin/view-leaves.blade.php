...
@section('content')
    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-4 sm:p-6 overflow-x-hidden">
            <div
                class=" w-2xl mx-auto mt-7 p-4 text-center bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-2  text-3xl font-semibold text-gray-900 dark:text-white">View Leave request Here</h5>
                 <div id="info-alert" class="flex items-center justify-between p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800" role="alert">
