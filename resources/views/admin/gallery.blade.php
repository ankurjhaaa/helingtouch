...
<div class="flex min-h-screen bg-gray-100">
    ...
    <main class="flex-1 p-4 sm:p-6 overflow-x-hidden">
        <div class="max-w-full mx-auto">
            ...
            <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-xl p-6 mb-8">
                ...
                <!-- Success Message -->
                @if (session('success'))
                    <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg shadow-md mb-4 relative transition-all duration-300">
                ...
                <!-- Validation Errors -->
                @if ($errors->any())
                    <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg shadow-md mb-4 relative transition-all duration-300">
                ...
                <form action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 bg-gray-50 text-gray-700 text-sm transition duration-200" value="{{ old('title') }}" />
                        @error('title')
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 bg-gray-50 text-gray-700 text-sm transition duration-200">
                    ...
                    <div>
                        ...
                        <input type="file" name="file" class="w-full text-sm border border-gray-300 rounded-lg bg-gray-50 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-200" />
                        @error('file')
                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                        @enderror
                    </div>

                    <button type="submit" class="w-full sm:w-auto bg-blue-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-200 font-medium hover:shadow-lg text-sm">
                        Upload
                    </button>
                </form>
            </div>
            ...
            <!-- Gallery Table -->
            <div class="max-w-full mx-auto bg-white rounded-xl shadow-xl p-6">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach ($galleryItems as $index => $item)
                                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <td class="px-4 py-3">
                                            @if($item->type == 'image')
                                                <img src="{{ asset('storage/' . $item->file) }}" class="w-20 h-16 object-cover rounded border border-gray-200" />
