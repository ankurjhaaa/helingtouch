    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-center">
            <div class="w-5/12 p-4">
                <div
                    class="max-w-sm  mt-7 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    {{-- Leave Form --}}
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Apply For Leave</h5>
            ...
            <div class="w-7/12 p-4">
                <div
                    class=" w-full mt-7 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Leave History</h5>
                    <p class="mb-5 font-normal text-gray-500 dark:text-gray-400">Here you can view your previous leave
                        applications.</p>
