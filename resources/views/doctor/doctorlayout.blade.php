    ...
    <nav class="bg-white shadow-md px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        ...
        <div class="relative">
            ...
            <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg py-2 z-50">
                <a href="{{ route('doctor.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Profile</a>
    ...
    <div class="flex">
        ...
        <aside id="sidebar"
            ...
            <nav class="flex flex-col space-y-2">
                <a href="{{ route('doctor.dashboard') }}" class="px-4 py-2 hover:bg-yellow-800 rounded">Dashboard</a>
                <a href="#" class="px-4 py-2 hover:bg-yellow-800 rounded">Appointments</a>
                <a href="#" class="px-4 py-2 hover:bg-yellow-800 rounded">Patients</a>
                <a href="#" class="px-4 py-2 hover:bg-yellow-800 rounded">Schedule</a>
