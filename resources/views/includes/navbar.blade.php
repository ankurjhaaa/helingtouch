                    ...
                    @auth
                        ...
                        <li>
                            ...
                            @if(auth()->user()->role === 'admin')
                                ...
                                <a href="" class="block px-4 py-2 hover:bg-gray-100 text-sm">Admin
                                    Dashboard</a>

                            @elseif(auth()->user()->role === 'doctor')

                                <a href=""
                                    class="block px-4 py-2 hover:bg-gray-100 text-sm">Doctor Dashboard</a>

                            @elseif(auth()->user()->role === 'user')

                                <a href="" class="block px-4 py-2 hover:bg-gray-100 text-sm">User
                                    Dashboard</a>
